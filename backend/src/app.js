...
const orderFinanceApprovalRoutes = require('./modules/orderFinanceApproval/orderFinanceApproval.routes');
...
app.use('/api/order-finance-approvals', orderFinanceApprovalRoutes);
