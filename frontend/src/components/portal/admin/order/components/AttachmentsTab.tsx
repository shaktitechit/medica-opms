    ...
    <div className="space-y-6">
          ...
          <div className="w-full max-w-lg rounded-xl border border-slate-200/90 bg-white p-6 shadow-xl dark:border-white/10 dark:bg-slate-900 transition-all">
            ...
            <form onSubmit={handleUploadSubmit} className="mt-4 space-y-4">
              ...
              >
                ...
                <div className="mt-4 flex text-sm text-slate-655 dark:text-slate-400 font-sans">
              ...
              {uploadFile && (
                <div className="rounded-lg bg-slate-50 p-3 dark:bg-slate-955 border border-slate-100 dark:border-white/5 flex items-center justify-between font-sans">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full mt-1.5 rounded-lg border border-slate-200/95 bg-white px-3 py-2 text-sm text-slate-900 outline-none transition focus:border-blue-600 focus:ring-2 focus:ring-blue-500/25 dark:border-white/15 dark:bg-slate-950 dark:text-slate-555 font-sans"
      ...
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200/90 dark:border-white/10 shadow-sm">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 font-sans">View, download, and upload files related to this admin, sales, finance, or dispatch record.</p>
        </div>
        <button
          type="button"
            ...
            <div key={deptKey} className="overflow-hidden rounded-xl border border-slate-200/90 dark:border-white/10 shadow-sm">
              <div className={`flex items-center justify-between border-b border-slate-200/90 dark:border-white/10 px-4 py-3.5 ${colors.bg}`}>
                <div className="flex items-center gap-2">
                  <span className={`inline-flex rounded px-2 py-0.5 text-xs font-semibold uppercase tracking-wider ${colors.text} bg-white/70 dark:bg-slate-955 border ${colors.border}`}>
                    {label}
                  </span>
                  ...
                  <div key={att._id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 transition hover:bg-slate-50/50 dark:hover:bg-white/5">
                    <div className="flex items-start gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        {att.remarks && att.remarks.trim() && (
                          <p className="mt-1.5 text-xs text-slate-655 dark:text-slate-300 italic bg-slate-50 dark:bg-slate-950/40 px-2.5 py-1 rounded-md border border-slate-100 dark:border-white/5 inline-block">
                            <span className="font-semibold not-italic text-slate-505 mr-1 font-sans">Remark:</span> {att.remarks}
                          </p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-2 flex-shrink-0">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-lg border border-rose-200 px-3 py-1.5 text-xs font-medium text-rose-700 bg-white hover:bg-rose-50 transition dark:border-rose-955 dark:text-rose-400 dark:bg-slate-950 dark:hover:bg-rose-950/20 disabled:opacity-50"
                      >
                        <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
