...
interface AdminPartyLeaderboardProps {
  orders: any[];
...
export default function AdminPartyLeaderboard({
  orders,
  isOrdersFetching,
  partyNameById,
}: AdminPartyLeaderboardProps) {
  ...
  const handleDownload = () => {
    ...
    downloadCsvFile(
      reportFilename("adminpartyleaderboard", selectedYears, selectedMonths),
      headers,
      rows,
      [
        `Report: AdminPartyLeaderboard`,
