...
export function ConfirmDeleteTransportAgentModal({
  transportAgentId,
  transportAgentLabel,
  isDeleting,
  onClose,
  onConfirm,
}: ConfirmDeleteTransportAgentModalProps) {
  const open = transportAgentId != null && transportAgentId !== "";
