...
export default function ListAccountOrdersPage() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-3 overflow-hidden">
      ...
      <div className="relative shrink-0 overflow-hidden rounded-xl border border-blue-500/10 bg-gradient-to-r from-blue-600/5 to-teal-600/10 px-4 py-2.5 shadow-sm dark:from-blue-500/5 dark:to-teal-500/5">
