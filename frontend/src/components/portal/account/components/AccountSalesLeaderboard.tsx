...
interface AccountSalesLeaderboardProps {
  orders: any[];
...
export default function AccountSalesLeaderboard({
  orders,
  isOrdersFetching,
  userNameById,
}: AccountSalesLeaderboardProps) {
  ...
  const handleDownload = () => {
    ...
    downloadCsvFile(
      reportFilename("accountsalesleaderboard", selectedYears, selectedMonths),
      headers,
      rows,
      [
        `Report: AccountSalesLeaderboard`,
