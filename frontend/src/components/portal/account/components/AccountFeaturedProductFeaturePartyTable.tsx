...
interface AccountFeaturedProductFeaturePartyTableProps {
  orders: any[];
  isOrdersFetching: boolean;
}

export default function AccountFeaturedProductFeaturePartyTable({
  orders,
  isOrdersFetching,
}: AccountFeaturedProductFeaturePartyTableProps) {
  ...
  const handleDownload = () => {
    ...
    downloadCsvFile(
      reportFilename("account_product_feature_party", selectedYears, selectedMonths),
      headers,
      rows,
      [
