...
interface AccountProductLeaderboardProps {
  orders: any[];
...
export default function AccountProductLeaderboard({
  orders,
  isOrdersFetching,
}: AccountProductLeaderboardProps) {
  ...
  const handleDownload = () => {
    ...
    downloadCsvFile(
      reportFilename("accountproductleaderboard", selectedYears, selectedMonths),
      headers,
      rows,
      [
        `Report: AccountProductLeaderboard`,
