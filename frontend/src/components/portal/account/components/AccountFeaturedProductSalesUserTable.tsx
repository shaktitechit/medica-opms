...
interface AccountFeaturedProductSalesUserTableProps {
  orders: any[];
  isOrdersFetching: boolean;
}

export default function AccountFeaturedProductSalesUserTable({
  orders,
  isOrdersFetching,
}: AccountFeaturedProductSalesUserTableProps) {
  ...
  const handleDownload = () => {
    ...
    downloadCsvFile(
      reportFilename("account_product_sales_user", selectedYears, selectedMonths),
      headers,
      rows,
      [
