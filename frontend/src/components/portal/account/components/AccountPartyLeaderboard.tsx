...
export default function AccountPartyLeaderboard({
  orders,
  isOrdersFetching,
  partyNameById,
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <button
                  ...
                  className="text-xs font-semibold text-blue-650 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 hover:underline cursor-pointer"
                >
                  View All
                </button>
              </div>
