...
const NEXT_STATUS_MAP: Record<string, PipelineStatus | null> = {
  ...
  transporter_assigned: "out_for_delivery",
  vehicle_assigned:     "out_for_delivery",
  pickup_pending:       "out_for_delivery",
...
interface TransportsTabProps {
  ...
  /** Now receives remarks as third arg */
  onUpdateStatus: (transportId: string, nextStatus: string, remarks?: string) => void;
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {nextStatus && (
                            <button
                              ...
                              onClick={() => openConfirm(trId, nextStatus, dispatchId)}
