...
import { DISPATCH_ORDER_STATUSES, PRIORITY_OPTIONS } from "@/components/portal/shared/orderStatusOptions";
                ...
                return (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-2 sm:flex sm:items-center sm:gap-8 lg:w-[280px] lg:shrink-0 text-[11px] text-slate-500 dark:text-slate-400">
                        ...
                        <span className="mt-0.5 font-bold tabular-nums text-slate-900 dark:text-slate-555 dark:text-slate-50 text-xs">
