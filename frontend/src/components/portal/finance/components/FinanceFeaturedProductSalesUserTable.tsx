...
interface FinanceFeaturedProductSalesUserTableProps {
  orders: any[];
  isOrdersFetching: boolean;
}

export default function FinanceFeaturedProductSalesUserTable({
  orders,
  isOrdersFetching,
}: FinanceFeaturedProductSalesUserTableProps) {
  ...
  const handleDownload = () => {
    ...
    downloadCsvFile(
      reportFilename("finance_product_sales_user", selectedYears, selectedMonths),
      headers,
      rows,
      [
