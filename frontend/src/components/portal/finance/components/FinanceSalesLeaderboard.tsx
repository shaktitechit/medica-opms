...
interface FinanceSalesLeaderboardProps {
  orders: any[];
...
export default function FinanceSalesLeaderboard({
  orders,
  isOrdersFetching,
  userNameById,
}: FinanceSalesLeaderboardProps) {
  ...
  const handleDownload = () => {
    ...
    downloadCsvFile(
      reportFilename("financesalesleaderboard", selectedYears, selectedMonths),
      headers,
      rows,
      [
        `Report: FinanceSalesLeaderboard`,
