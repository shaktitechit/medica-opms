...
interface FinanceFeaturedProductGroupFeaturedPartyTableProps {
  orders: any[];
  isOrdersFetching: boolean;
}

export default function FinanceFeaturedProductGroupFeaturedPartyTable({
  orders,
  isOrdersFetching,
  ...
  const handleDownload = () => {
    ...
    downloadCsvFile(
      reportFilename("finance_product_group_party", selectedYears, selectedMonths),
      headers,
      rows,
      [
