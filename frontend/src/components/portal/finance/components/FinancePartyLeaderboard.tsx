...
interface FinancePartyLeaderboardProps {
  orders: any[];
...
export default function FinancePartyLeaderboard({
  orders,
  isOrdersFetching,
  partyNameById,
}: FinancePartyLeaderboardProps) {
  ...
  const handleDownload = () => {
    ...
    downloadCsvFile(
      reportFilename("financepartyleaderboard", selectedYears, selectedMonths),
      headers,
      rows,
      [
        `Report: FinancePartyLeaderboard`,
