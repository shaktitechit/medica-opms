...
function statusBadgeClass(status: string): string {
  if (status === "rejected") {
    return "bg-rose-550/10 text-rose-700 ring-1 ring-rose-600/20 dark:bg-rose-950/30 dark:text-rose-350 dark:ring-rose-500/30";
  }
          ...
          <div className="space-y-4">
            {approvals.map((app) => (
              ...
              >
                ...
                <div className="mt-3 grid gap-3 text-xs sm:grid-cols-3 font-sans">
                    ...
                    <table className="w-full text-left bg-white/40 dark:bg-slate-900/30">
                      ...
                      <tbody className="divide-y divide-slate-100 dark:divide-white/5">
                        {app.approval_items.map((it: any) => (
                          <tr key={it._id || it.order_item_id} className="hover:bg-slate-50/50 dark:hover:bg-white/5">
                ...
                <div className="mt-3 text-xs font-sans text-slate-600 dark:text-slate-350">
                  {app.approval_notes && (
