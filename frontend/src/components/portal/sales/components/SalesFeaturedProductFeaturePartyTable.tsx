...
interface SalesFeaturedProductFeaturePartyTableProps {
  orders: any[];
...
export default function SalesFeaturedProductFeaturePartyTable({
  orders,
  isOrdersFetching,
}: SalesFeaturedProductFeaturePartyTableProps) {
  const {
    availableYears,
    selectedYears,
    setSelectedYears,
  ...
  const matrix = useMemo(() => {
    ...
    return map;
  }, [filteredOrders, productIds, partyIds, productIdSet, partyIdSet]);
  ...
  const handleDownload = () => {
    ...
    downloadCsvFile(
      reportFilename("sales_product_feature_party", selectedYears, selectedMonths),
      headers,
      rows,
      [
  ...
  return (
    <FeaturedMatrixTableFrame
      ...
      subtitle="Net quantity by featured product across each featured party (your orders)"
